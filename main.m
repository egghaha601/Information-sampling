...
tps=zeros(1,10);
iveki=zeros(1,10);
for num_c=100:100:1000 %number of categories, you can also change the settings according to Fig. 2(b) and Fig. 2(c) 
    ...
    for time=1:1:500 % each result is reported by averaging 500 simulations
